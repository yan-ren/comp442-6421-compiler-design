 ...
 tag1                                       % while statement
            ...
            sub        r3,r1,r2             
            sw         -44(r14),r3          
            lw         r1,-20(r14)          % relExpr i lt t4_1550228904
            lw         r2,-44(r14)          
            clt        r3,r1,r2             
            sw         -48(r14),r3          
            lw         r3,-48(r14)          
 ...
 tag3                                       % while statement
            ...
            sub        r1,r3,r2             
            sw         -64(r14),r1          
            lw         r3,-24(r14)          % relExpr j lt t9_1550228904
            lw         r2,-64(r14)          
            clt        r1,r3,r2             
            sw         -68(r14),r1          
            lw         r1,-68(r14)          
 ...
 main       entry                           % start program
            ...
            sw         -132(r14),r3         
            lw         r3,-100(r14)         % pass t43_1550228904 into parameter
            sw         -136(r14),r3         
            ...
            lw         r3,-8(r14)           % pass arr into parameter
            sw         -132(r14),r3         
            lw         r3,-108(r14)         % pass t45_1550228904 into parameter
            sw         -136(r14),r3         
            subi       r14,r14,124          % increment stack frame
            ...
            lw         r3,-8(r14)           % pass arr into parameter
            sw         -132(r14),r3         
            lw         r3,-116(r14)         % pass t47_1550228904 into parameter
            sw         -136(r14),r3         
            subi       r14,r14,124          % increment stack frame
            jl         r15,printArray       % jump to funciton: printArray
            addi       r14,r14,124          % decrement stack frame

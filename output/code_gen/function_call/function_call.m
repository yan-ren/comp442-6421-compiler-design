 ...
 f                                          
            ...
            add        r3,r1,r2             
            sw         -28(r14),r3          
            lw         r1,-28(r14)          % load value for retval
            sw         -20(r14),r1          % assign retval
            lw         r1,-20(r14)          % print var: retval
            jl         r15,putint           
            ...
            hlt                             % end of function definition: f
            align                           
 ...
 main       entry                           % start program
            ...
            sw         -24(r14),r1          
            lw         r1,-24(r14)          % load value for b
            sw         -12(r14),r1          % assign b
            addi       r1,r0,3              % load intnum: 3
            sw         -28(r14),r1          
            lw         r1,-28(r14)          % load value for c
            ...
            add        r3,r1,r2             
            sw         -40(r14),r3          
            lw         r1,-40(r14)          % load value for a
            sw         -8(r14),r1           % assign a
            lw         r1,-8(r14)           % print var: a
            jl         r15,putint           
            addi       r1,r0,0              % print a newline
            lb         r2,newline(r1)       
            putc       r2                   

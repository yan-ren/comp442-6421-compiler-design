...
public class ParserTest {
    ...
    void testInitFirstFollowSet() throws IOException {
        ...
        assertEquals(new HashSet<String>(Arrays.asList("struct", "impl", "func")), parser.firstSet.get("REPTPROG0"));
    ...
    void testInitParserTable() throws IOException {
        ...
        assertEquals(
                new ArrayList<String>(List.of("func", "id", "openpar", "FPARAMS", "closepar", "arrow", "RETURNTYPE")),
